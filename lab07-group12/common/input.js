...
class Input{
    ...
    * @return {V2} the current position of the mouse.
    */
    ...
    * @return {V2} the current movement of the mouse.
    */
...
Input.inner.mousePosition = new V2();
Input.inner.mousePositionDelta = new V2();
Input.inner.mousePositionDeltaBuffer = new V2();
