...
class Renderer {
    ...
    */
    setUniformData(model, camera, shaderData){
        ...
        gl.uniformMatrix4fv(matrixLocation, false, new Float32Array(model.modelMatrix));

        // TODO: Set view matrix uniform (u_matrixV) data.
        let viewLocation = gl.getUniformLocation(this.program, "u_matrixV");
        gl.uniformMatrix4fv(viewLocation, false, new Float32Array(camera.viewMatrix));

        // TODO: Set projection matrix uniform (u_matrixP) data.
        let projLocation = gl.getUniformLocation(this.program, "u_matrixP");
        gl.uniformMatrix4fv(projLocation, false, new Float32Array(camera.projectionMatrix));
