...
class ModelTransform{
    ...
    */
    ...
    updateMatrix(){
        ...
        let tMatrix = M4.translationMatrix(this.position.x, this.position.y, this.position.z);

        let xMatrix = M4.rotationMatrixX(this.rotation.x);
        let yMatrix = M4.rotationMatrixY(this.rotation.y);
        let zMatrix = M4.rotationMatrixZ(this.rotation.z);

        let sMatrix = M4.scaleMatrix(this.scale.x, this.scale.y, this.scale.z);

        this.modelMatrix = M4.multM4(tMatrix, yMatrix);
        this.modelMatrix = M4.multM4(this.modelMatrix, xMatrix);
        this.modelMatrix = M4.multM4(this.modelMatrix, zMatrix);
        this.modelMatrix = M4.multM4(this.modelMatrix, sMatrix);
