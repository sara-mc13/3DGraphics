...
Primitives.Triangle = class{
    static getMesh(){
        ...
        let indices =  [0, 1, 2];
        MeshCache["triangle"] = GLUtils.createMesh("triangle", gl.TRIANGLES, indices, positions);
        return MeshCache["triangle"];
    }
}
...
Primitives.Quad = class{
    static getMesh(){
        ...
        let indices =  [0, 1, 2,
                        2, 3, 0];
        MeshCache["quad"] = GLUtils.createMesh("quad", gl.TRIANGLES, indices, positions);
        return MeshCache["quad"];
    }
}
...
Primitives.Cube = class{
    static getMesh(){
        ...
        MeshCache["cube"] = GLUtils.createMesh("cube", gl.TRIANGLES, indices, positions);
        return MeshCache["cube"];
    }
}
...
Primitives.Tetrahedron = class{
    static getMesh(){
        ...
        MeshCache["tetrahedron"] = GLUtils.createMesh("tetrahedron", gl.TRIANGLES, indices, positions);
        return MeshCache["tetrahedron"];
    }
}
...
Primitives.Pyramid = class{
    static getMesh(){
        ...
        MeshCache["pyramid"] = GLUtils.createMesh("pyramid", gl.TRIANGLES, indices, positions);
        return MeshCache["pyramid"];
    }
}
...
Primitives.Plane = class{
    static getMesh(xRes=10, zRes=10){
        ...
        MeshCache[meshName] = GLUtils.createMesh(meshName, gl.TRIANGLES, indices, positions);
        return MeshCache[meshName];
    }
}
...
Primitives.Sphere = class {
    static getMesh(sectorCount = 20, stackCount = 20){
        ...
        MeshCache["sphere"] = GLUtils.createMesh("sphere", gl.TRIANGLES, indices, positions);
        return MeshCache["sphere"];
    }
}
...
Primitives.Cylinder = class {
    static getMesh(sectorCount = 20){
        ...
        MeshCache["cylinder"] = GLUtils.createMesh("cylinder", gl.TRIANGLES, indices, positions);
        return MeshCache["cylinder"];
    }
}
