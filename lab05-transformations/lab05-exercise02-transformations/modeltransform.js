...
class ModelTransform{
    ...
    */
    ...
    updateMatrix(){
        ...
        let translateM = M3.translationMatrix(this.position[0], this.position[1]);
        let rotateM = M3.rotationMatrix(this.rotation);
        let scaleM = M3.scaleMatrix(this.scale[0], this.scale[1]);

        this.modelMatrix = M3.multM3(translateM, rotateM);
        this.modelMatrix = M3.multM3(this.modelMatrix, scaleM);
